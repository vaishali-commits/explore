...
<script src="addconference.js"></script>
<style>
body{
...
<header>
<section><a href="conference.jsp"><img src="back.png"></a></section><h1>ADD CONFERENCE</h1>
</header>
<fieldset>
<form action="addConferenceController2" method="post" name='registration' onSubmit="return formValidation();">
<br/><br/>
...
Type Of Category<select name="s5">
