...
<header>
<section><a href="Conference2.jsp"><img src="back.png"></a></section><h1>ADD CONFERENCE</h1>
</header>
<fieldset>
<form action="AddConferenceController" method="post" name='registration' onSubmit="return formValidation();">
<br/><br/>
